...
try:
    ...
    game_name="OpenLife"
    version="Alpha 11.2 [9 Nov 2022] [DeprecationWarning]"
    def casino_menu():
    ...
    def mainmenu():        
        ...
        print("[11] Check For Updates [Use at own risk!]")
        print("[0] About Game")
        div()
        ...
        if ch == 1:
            ...
            print("[-] Rearranged Main Menu items to match newer versions more")
            print("[-] Added Quick Life option")
            print("[-] Updated logo")
            div()
            print("Section 2: Deprecation [Message from Alpha 11.1]")
            div()
