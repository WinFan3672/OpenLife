...
try:
    ...
    game_name="OpenLife"
    version="Alpha 11.1 [5 Nov 2022] [DeprecationWarning]"
    def casino_menu():
    ...
    def uni_age():
        ...
        global salary, hours, work_e, money
        #when parents die
    ...
    def mainmenu():        
        ...
        print("[6] Exit")
        print("[7] Changelog")
        print("[8] Check For Updates [Use at own risk!]")
        print("[0] About Game")
        div()
        print("Version:",version)
        div()
        print("DeprecationWarning: Alpha 11 will be deprecated when Alpha 15 is released!")
        div()
        try:
            ch=int(input(">>"))
        except:
        ...
        if ch == 1:
            ...
            print("Alpha 11.1")
            div()
            print("Section 1: Changes Made")
            print("[-] Changed main menu logo")
            print("[-] Added DeprecationWarning to main menu.")
            print("[-] Removed Main Menu Option [4]")
            print("[-] Added Main Main Menu Option [8] [Check for Updates]")
            print("[-] Added new theme. This theme is now the default.")
            div()
            print("Section 2: Deprecation")
            print("Alpha 11 is considered a legacy version of OpenLife, and its code is extremely outdated.")
            print("It has 3500 lines of code, compared to Alpha 13's 7500 and Alpha 14's 9000.")
            print("It has become aged very, very poorly, and as such, I have decided that the sun has set for this version.")
            print("I will not be maintaining it, so, for security reasons, the Challenge Downloader was removed.")
            print("Feel free to play it, just do know that I will not be fixing bugs or security issues.")
            print("That is, unless someone reports a bug with it before Alpha 15's release.")
            print("Enjoy playing OpenLife, and have a good day.")
            div()
            br()
            mainmenu()
        elif ch == 8:
