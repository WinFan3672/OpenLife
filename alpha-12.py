...
try:
    ...
    def mainmenu():
        ...
        for l in logo:
            print(l)
        div()
        print("Alpha 12- The Job Update Part II")
        print("News! You can save and load the game!")
        print("News! You can retire and get promoted.")
        print("[See the in-game changelog for more changes")
        div()
        print("[1] New Life")
        print("[2] Load Life")
        print("[3] Credits")
